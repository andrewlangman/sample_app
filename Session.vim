...
set shortmess=aoO
badd +16 public/index.html
badd +10 public/hello.html
badd +11 app/controllers/static_pages_controller.rb
badd +54 spec/requests/static_pages_spec.rb
badd +1 app/views/static_pages/home.html.erb
badd +7 app/views/static_pages/help.html.erb
badd +6 config/routes.rb
badd +7 app/views/static_pages/about.html.erb
...
exe '4resize ' . ((&lines * 13 + 16) / 33)
exe 'vert 4resize ' . ((&columns * 60 + 61) / 122)
argglobal
nnoremap <buffer> <silent> g} :exe        "ptjump =RubyCursorIdentifier()"
nnoremap <buffer> <silent> } :exe          "ptag =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g] :exe      "stselect =RubyCursorIdentifier()"
...
wincmd w
argglobal
edit app/views/static_pages/contact.html.erb
nnoremap <buffer> <silent> g} :exe        "ptjump =RubyCursorIdentifier()"
nnoremap <buffer> <silent> } :exe          "ptag =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g] :exe      "stselect =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g :exe        "stjump =RubyCursorIdentifier()"
